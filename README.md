...
Ignora as que já foram salvas antes
Automação
Se achar uma nova → abre automaticamente
Se não tiver nessa página → vai pra próxima
Quando acaba tudo → para sozinho
Quando abre uma empresa
Ele pega:
ID
Nome
Dono
